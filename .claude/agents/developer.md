...
# 2. Syntax check (see "Build Verification Commands by Tech Stack" in CLAUDE.md)
...
git add {changed files}   # git add -A is prohibited (see "Git Rules" in CLAUDE.md)
...
**Commit message prefix rules:** See "Git Rules" in CLAUDE.md
...
- When adopting, verify that it meets the adoption criteria in the "Library Usage Policy" in CLAUDE.md
