...
> **EN canonical**: 2026-04-25 of wiki/en/Agents-Delivery.md
> **Audience**: エージェント開発者

このページはもとの Agents-Reference.md を 5 ページに分割したもの（#42）です。Delivery ドメインエージェントを扱います。他のドメインは兄弟ページを参照してください: [Flow Orchestrator・横断系](./Agents-Orchestrators.md)、[Discovery](./Agents-Discovery.md)、[Operations](./Agents-Operations.md)、[Maintenance](./Agents-Maintenance.md)。

## 目次

- [Deliveryドメイン](#deliveryドメイン)
- [関連ページ](#関連ページ)
- [正規ソース](#正規ソース)
