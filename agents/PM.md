...
description: |
  ...
  各エージェント（planner / designer / architect / developer / tester / reviewer）を順番に起動し、
...
Phase 5: テスト           → tester     → ⏸ ユーザー承認
Phase 6: レビュー         → reviewer   → ⏸ ユーザー承認 → 完了
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Phase 4 実装             ✅ 承認済み
  Phase 5 テスト           ✅ 承認済み ({N} テスト通過)
  Phase 6 レビュー         ✅ 承認済み (CRITICAL なし)
